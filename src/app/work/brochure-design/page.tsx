...
const project = profile.projects.find((item) => item.slug === "brochure-design");

export const metadata: Metadata = {
  title: "Brochures | Alden Jay Centino",
  description: "Brochures project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Brochures | Alden Jay Centino",
