...
const project = profile.projects.find((item) => item.slug === "synthwave-design");

export const metadata: Metadata = {
  title: "Synthwave Event Flyers | Alden Jay Centino",
  description: "Synthwave Event Flyers project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Synthwave Event Flyers | Alden Jay Centino",
    description: "Synthwave Event Flyers gallery.",
    images: ["/prof.jpg"],
  },
};

export default function SynthwaveDesignPage() {
  const images =
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Synthwave Event Flyers"}
              description={
                project?.description ??
                "Synthwave Event Flyers gallery."
              }
            />
