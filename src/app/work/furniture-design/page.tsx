...
const project = profile.projects.find((item) => item.slug === "furniture-design");

export const metadata: Metadata = {
  title: "Furniture Design | Alden Jay Centino",
  description: "Furniture Design project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Furniture Design | Alden Jay Centino",
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Furniture Design"}
              description={
                project?.description ??
                "Furniture Design project preview gallery."
              }
            />
