...
const project = profile.projects.find((item) => item.slug === "vivid-design");

export const metadata: Metadata = {
  title: "Vivid Launch Identity | Alden Jay Centino",
  description: "Vivid Launch Identity project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Vivid Launch Identity | Alden Jay Centino",
...
export default function VividDesignPage() {
  const images =
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Vivid Launch Identity"}
              description={
                project?.description ??
                "Vivid Launch Identity gallery."
              }
            />
