...
const project = profile.projects.find((item) => item.slug === "creator-design");

export const metadata: Metadata = {
  title: "Creator Thumbnail Kit | Alden Jay Centino",
  description: "Creator Thumbnail Kit project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Creator Thumbnail Kit | Alden Jay Centino",
    description: "Creator Thumbnail Kit gallery.",
    images: ["/Profile.jpg"],
  },
};
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Creator Thumbnail Kit"}
              description={
                project?.description ??
                "Creator Thumbnail Kit gallery."
              }
            />
