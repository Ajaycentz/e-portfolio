...
const project = profile.projects.find((item) => item.slug === "neon-design");

export const metadata: Metadata = {
  title: "Neon Market Posters | Alden Jay Centino",
  description: "Neon Market Posters project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Neon Market Posters | Alden Jay Centino",
...
export default function NeonDesignPage() {
  const images =
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Neon Market Posters"}
              description={
                project?.description ??
                "Neon Market Posters gallery."
              }
            />
