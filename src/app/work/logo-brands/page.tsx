...
const project = profile.projects.find((item) => item.slug === "logo-brands");

export const metadata: Metadata = {
  title: "Logo Brands | Alden Jay Centino",
  description: "Logo Brands project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Logo Brands | Alden Jay Centino",
...
export default function LogoBrandsPage() {
  const images =
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Logo Brands"}
              description={
                project?.description ??
                "Logo Brands gallery."
              }
