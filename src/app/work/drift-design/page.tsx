...
const project = profile.projects.find((item) => item.slug === "drift-design");

export const metadata: Metadata = {
  title: "Drift Commerce Visual System | Alden Jay Centino",
  description: "Drift Commerce Visual System project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Drift Commerce Visual System | Alden Jay Centino",
...
export default function DriftDesignPage() {
  const images =
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Drift Commerce Visual System"}
              description={
                project?.description ??
                "Drift Commerce Visual System gallery."
              }
            />
