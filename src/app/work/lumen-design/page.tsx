...
const project = profile.projects.find((item) => item.slug === "lumen-design");

export const metadata: Metadata = {
  title: "Lumen Studio Digital Portfolio | Alden Jay Centino",
  description: "Lumen Studio Digital Portfolio project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Lumen Studio Digital Portfolio | Alden Jay Centino",
    description: "Lumen Studio Digital Portfolio gallery.",
    images: ["/Profile.jpg"],
  },
};
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Lumen Studio Digital Portfolio"}
              description={
                project?.description ??
                "Lumen Studio Digital Portfolio gallery."
              }
            />
