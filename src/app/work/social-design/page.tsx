...
const project = profile.projects.find((item) => item.slug === "social-design");

export const metadata: Metadata = {
  title: "Pulse Social Kit | Alden Jay Centino",
  description: "Pulse Social Kit project gallery from Alden Jay Centino's portfolio.",
  openGraph: {
    title: "Pulse Social Kit | Alden Jay Centino",
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:px-8 lg:grid-cols-[1.6fr_0.8fr]">
          <div className="space-y-10">
            <SectionHeading
              ...
              title={project?.title ?? "Pulse Social Kit"}
              description={
                project?.description ??
                "Pulse Social Kit gallery."
              }
            />
